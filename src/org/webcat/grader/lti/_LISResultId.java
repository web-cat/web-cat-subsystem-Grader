/*==========================================================================*\
 ...
 |  DO NOT EDIT.  Make changes to LISResultId.java instead.
 |*-------------------------------------------------------------------------*|
 ...
 */
public abstract class _LISResultId
    extends org.webcat.core.EOBase
{
    ...
    // ----------------------------------------------------------
    /**
     * Creates a new _LISResultId object.
     */
    public _LISResultId()
    {
        super();
     ...
     * LISResultId object given required
     * attributes and relationships.
     * @param editingContext The context in which the new object will be
     * inserted
     * @param lisResultSourcedIdValue
     * @param assignmentOfferingValue
     * @param lmsInstanceValue
     * @param userValue
     * @return The newly created object
     */
    public static LISResultId create(
        EOEditingContext editingContext,
        String lisResultSourcedIdValue,
        org.webcat.grader.AssignmentOffering assignmentOfferingValue,
        org.webcat.core.lti.LMSInstance lmsInstanceValue,
        org.webcat.core.User userValue
        )
    {
        LISResultId eoObject = (LISResultId)
            EOUtilities.createAndInsertInstance(
                editingContext,
                _LISResultId.ENTITY_NAME);
        eoObject.setLisResultSourcedId(lisResultSourcedIdValue);
        eoObject.setAssignmentOfferingRelationship(assignmentOfferingValue);
        eoObject.setLmsInstanceRelationship(lmsInstanceValue);
     ...
     */
    public static LISResultId localInstance(
        EOEditingContext editingContext, LISResultId eo)
    {
        return (eo == null)
            ? null
            : (LISResultId)EOUtilities.localInstanceOfObject(
                editingContext, eo);
    }
     ...
     */
    public static LISResultId forId(
        EOEditingContext ec, int id)
    {
        LISResultId obj = null;
        if (id > 0)
        {
    ...
    {
        return (LISResultId)ec.faultForGlobalID(id, ec);
    }
    ...
    // Attributes ---
    public static final String LIS_RESULT_SOURCED_ID_KEY = "lisResultSourcedId";
    public static final ERXKey<String> lisResultSourcedId =
        new ERXKey<String>(LIS_RESULT_SOURCED_ID_KEY);
    ...
    public static final String ENTITY_NAME = "LISResultId";
     ...
     */
    public LISResultId localInstance(EOEditingContext editingContext)
    {
        return (LISResultId)EOUtilities.localInstanceOfObject(
            editingContext, this);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public LISResultId refetch(EOEditingContext editingContext)
    {
        return (LISResultId)refetchObjectFromDBinEditingContext(
            editingContext);
    }
    ...
    // ----------------------------------------------------------
    /**
     * Retrieve this object's <code>lisResultSourcedId</code> value.
     * @return the value of the attribute
     */
    public String lisResultSourcedId()
    {
        return (String)storedValueForKey( "lisResultSourcedId" );
    }


    // ----------------------------------------------------------
    /**
     * Change the value of this object's <code>lisResultSourcedId</code>
     * property.
     *
     * @param value The new value for this property
     */
    public void setLisResultSourcedId( String value )
    {
        if (log.isDebugEnabled())
        {
            log.debug( "setLisResultSourcedId("
                + value + "): was " + lisResultSourcedId() );
        }
        takeStoredValueForKey( value, "lisResultSourcedId" );
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static NSArray<LISResultId> objectsWithFetchSpecification(
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<LISResultId> allObjects(
        EOEditingContext context)
    {
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<LISResultId> objectsMatchingQualifier(
        EOEditingContext context,
    ...
    {
        WCFetchSpecification<LISResultId> fspec =
     ...
     */
    public static LISResultId firstObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier,
        NSArray<EOSortOrdering> sortOrderings)
    {
     ...
     */
    public static LISResultId uniqueObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier) throws EOUtilities.MoreThanOneException
    {
        ...
        if (objects.size() > 1)
        {
            String msg = "fetching LISResultId";
            try
            {
                if (qualifier != null)
                {
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<LISResultId> objectsMatchingValues(
        EOEditingContext context,
     ...
     * @return the first entity that was retrieved, or null if there was none
     */
    public static LISResultId firstObjectMatchingValues(
        EOEditingContext context,
        NSArray<EOSortOrdering> sortOrderings,
        Object... keysAndValues)
    {
     ...
     *     if there is more than one matching object
     */
    public static LISResultId uniqueObjectMatchingValues(
        EOEditingContext context,
        ...
        throws EOUtilities.MoreThanOneException
    {
        try
        {
            return (LISResultId)EOUtilities.objectMatchingValues(
    ...
    static Logger log = Logger.getLogger(LISResultId.class);
}
