    ...
    extends org.webcat.core.EOBase
{
    ...
    {
        return (EnqueuedJob)ec.faultForGlobalID(id, ec);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public EnqueuedJob refetch(EOEditingContext editingContext)
    {
        return (EnqueuedJob)refetchObjectFromDBinEditingContext(
            editingContext);
    }
        ...
        EOQualifier qualifier) throws EOUtilities.MoreThanOneException
    {
        ...
        if (objects.size() > 1)
        {
            String msg = "fetching EnqueuedJob";
            try
            {
                if (qualifier != null)
                {
