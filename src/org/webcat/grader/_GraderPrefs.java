    ...
    extends org.webcat.core.EOBase
{
    ...
    {
        return (GraderPrefs)ec.faultForGlobalID(id, ec);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public GraderPrefs refetch(EOEditingContext editingContext)
    {
        return (GraderPrefs)refetchObjectFromDBinEditingContext(
            editingContext);
    }
