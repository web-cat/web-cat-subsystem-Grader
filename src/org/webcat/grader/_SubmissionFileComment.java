    ...
    extends org.webcat.core.EOBase
{
    ...
    {
        return (SubmissionFileComment)ec.faultForGlobalID(id, ec);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public SubmissionFileComment refetch(EOEditingContext editingContext)
    {
        return (SubmissionFileComment)refetchObjectFromDBinEditingContext(
            editingContext);
    }
    ...
    {
        WCFetchSpecification<SubmissionFileComment> fspec =
            new WCFetchSpecification<SubmissionFileComment>(
        ...
        EOQualifier qualifier) throws EOUtilities.MoreThanOneException
    {
        ...
        if (objects.size() > 1)
        {
            String msg = "fetching SubmissionFileComment";
            try
            {
                if (qualifier != null)
                {
