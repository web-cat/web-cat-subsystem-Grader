/*==========================================================================*\
 |  _StudentExtension.java
 |*-------------------------------------------------------------------------*|
 |  Created by eogenerator
 |  DO NOT EDIT.  Make changes to StudentExtension.java instead.
 |*-------------------------------------------------------------------------*|
 ...
 */
public abstract class _StudentExtension
    extends org.webcat.core.EOBase
{
    ...
    // ----------------------------------------------------------
    /**
     * Creates a new _StudentExtension object.
     */
    public _StudentExtension()
    {
        super();
    }
     ...
     * StudentExtension object given required
     ...
     */
    public static StudentExtension create(
        EOEditingContext editingContext,
        org.webcat.grader.AssignmentOffering assignmentOfferingValue,
        org.webcat.core.User userValue
        )
    {
        StudentExtension eoObject = (StudentExtension)
            EOUtilities.createAndInsertInstance(
                editingContext,
                _StudentExtension.ENTITY_NAME);
     ...
     */
    public static StudentExtension localInstance(
        EOEditingContext editingContext, StudentExtension eo)
    {
        return (eo == null)
            ? null
            : (StudentExtension)EOUtilities.localInstanceOfObject(
                editingContext, eo);
    }
     ...
     */
    public static StudentExtension forId(
        EOEditingContext ec, int id)
    {
        StudentExtension obj = null;
        if (id > 0)
        {
            NSArray<StudentExtension> objects =
    ...
    {
        return (StudentExtension)ec.faultForGlobalID(id, ec);
    }
    ...
    public static final String ENTITY_NAME = "StudentExtension";
     ...
     */
    public StudentExtension localInstance(EOEditingContext editingContext)
    {
        return (StudentExtension)EOUtilities.localInstanceOfObject(
            editingContext, this);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public StudentExtension refetch(EOEditingContext editingContext)
    {
        return (StudentExtension)refetchObjectFromDBinEditingContext(
            editingContext);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static NSArray<StudentExtension> objectsWithFetchSpecification(
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<StudentExtension> allObjects(
        EOEditingContext context)
    {
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<StudentExtension> objectsMatchingQualifier(
        EOEditingContext context,
    ...
    {
        WCFetchSpecification<StudentExtension> fspec =
            new WCFetchSpecification<StudentExtension>(
     ...
     */
    public static StudentExtension firstObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier,
        NSArray<EOSortOrdering> sortOrderings)
    {
     ...
     */
    public static StudentExtension uniqueObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier) throws EOUtilities.MoreThanOneException
    {
        ...
        if (objects.size() > 1)
        {
            String msg = "fetching StudentExtension";
            try
            {
                if (qualifier != null)
                {
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<StudentExtension> objectsMatchingValues(
        EOEditingContext context,
     ...
     * @return the first entity that was retrieved, or null if there was none
     */
    public static StudentExtension firstObjectMatchingValues(
        EOEditingContext context,
        NSArray<EOSortOrdering> sortOrderings,
        Object... keysAndValues)
    {
     ...
     *     if there is more than one matching object
     */
    public static StudentExtension uniqueObjectMatchingValues(
        EOEditingContext context,
        ...
        throws EOUtilities.MoreThanOneException
    {
        try
        {
            return (StudentExtension)EOUtilities.objectMatchingValues(
    ...
    static Logger log = Logger.getLogger(StudentExtension.class);
}
