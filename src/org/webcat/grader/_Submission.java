    ...
    implements org.webcat.core.MigratoryAttributeOwner
{
    ...
    {
        return (Submission)ec.faultForGlobalID(id, ec);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public Submission refetch(EOEditingContext editingContext)
    {
        return (Submission)refetchObjectFromDBinEditingContext(
            editingContext);
    }
