    ...
    extends org.webcat.core.EOBase
{
    ...
    {
        return (Assignment)ec.faultForGlobalID(id, ec);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public Assignment refetch(EOEditingContext editingContext)
    {
        return (Assignment)refetchObjectFromDBinEditingContext(
            editingContext);
    }
        ...
        EOQualifier qualifier) throws EOUtilities.MoreThanOneException
    {
        ...
        if (objects.size() > 1)
        {
            String msg = "fetching Assignment";
            try
            {
                if (qualifier != null)
                {
