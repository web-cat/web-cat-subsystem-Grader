    ...
    extends org.webcat.core.EOBase
{
    ...
    {
        return (ResultFile)ec.faultForGlobalID(id, ec);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public ResultFile refetch(EOEditingContext editingContext)
    {
        return (ResultFile)refetchObjectFromDBinEditingContext(
            editingContext);
    }
    ...
    {
        WCFetchSpecification<ResultFile> fspec =
            new WCFetchSpecification<ResultFile>(
