    ...
    implements net.sf.webcat.core.MutableContainer.MutableContainerOwner
{
     ...
     */
    @SuppressWarnings("unchecked")
    public static NSArray<ScriptFile> objectsWithFetchSpecification(
     ...
     * @return the first entity that was retrieved, or null if there was none
     */
    public static ScriptFile firstObjectMatchingValues(
        EOEditingContext context,
        NSArray<EOSortOrdering> sortOrderings,
        Object... keysAndValues)
    {
     ...
     *     if there is more than one matching object
     */
    public static ScriptFile uniqueObjectMatchingValues(
        EOEditingContext context,
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<ScriptFile> pluginsAvailableToUser(
            EOEditingContext context,
            net.sf.webcat.core.User authorBinding
        )
    {
        EOFetchSpecification spec = EOFetchSpecification
            .fetchSpecificationNamed( "pluginsAvailableToUser", "ScriptFile" );
