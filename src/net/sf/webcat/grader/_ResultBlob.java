/*==========================================================================*\
 ...
 |  DO NOT EDIT.  Make changes to ResultBlob.java instead.
 |*-------------------------------------------------------------------------*|
 ...
 */
public abstract class _ResultBlob
    ...
    implements net.sf.webcat.core.MutableContainer.MutableContainerOwner
{
    ...
    // ----------------------------------------------------------
    /**
     * Creates a new _ResultBlob object.
     */
    public _ResultBlob()
    {
        super();
     ...
     * _ResultBlob object given required
     ...
     */
    public static ResultBlob create(
        EOEditingContext editingContext,
        boolean updateMutableFields
        )
    {
        ResultBlob eoObject = (ResultBlob)
            EOUtilities.createAndInsertInstance(
                editingContext,
                _ResultBlob.ENTITY_NAME);
     ...
     */
    public static ResultBlob localInstance(
        EOEditingContext editingContext, ResultBlob eo)
    {
        return (eo == null)
            ? null
            : (ResultBlob)EOUtilities.localInstanceOfObject(
                editingContext, eo);
    }
     ...
     */
    public static ResultBlob forId(
        EOEditingContext ec, int id )
    {
        ...
        if (id > 0)
        {
            ...
            {
                obj = (ResultBlob)results.objectAtIndex( 0 );
            }
        }
        return obj;
    }
    ...
    public static final String ENTITY_NAME = "ResultBlob";
     ...
     */
    public ResultBlob localInstance(EOEditingContext editingContext)
    {
        return (ResultBlob)EOUtilities.localInstanceOfObject(
            editingContext, this);
    }
    ...
    static Logger log = Logger.getLogger( ResultBlob.class );
}
